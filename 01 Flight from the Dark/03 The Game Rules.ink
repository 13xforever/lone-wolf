...
{ LIST_COUNT(DISCIPLINES) == 5:
    ...
    * [Chose your equipment] -> equipment
- else:
...
All you possess is an Axe and a Backpack containing 1 Meal. Hanging from your waist is a leather pouch containing {GP} Gold Crown{GP!=1:s}.
